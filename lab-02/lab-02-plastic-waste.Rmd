...
**Your answer:**
There is the Source pane where you can mark up your text and complete the assignments.
There is the Console/Terminal pane where you can see if there are errors.
There is the Environment History pane, which we use primarily for the GIT Tab, where we handke uploading to Git
The fourth pane is the Files pane, where we can access the Files we use.


**Question 2:** Verify that the dataset has loaded into the Environment pane. How many observations are in the dataset?
There are 240 in the .csv.
...
This means that there was no answer for that particular column and row.
...
No, I was very surprised by this. I looked and it is due to high imp0rts, very poor waste management, and high use in single use products.
...
- Which continent has the highest typical plastic waste per capita? Asia
- Which has the lowest? South America
- Which continent shows the most variation? Oceania
...
I choose 0.4. I felt that there is enough transparency that it was easy to see all the different slopes.
...
**Your answer:**
The the 'color' and 'fill'mare pertinent tot he actually data. Te 'alpha' level is not important to the data, only a display option to make things easier to read.
...
Violin plots show the density through the distribution shape. That means you can see gaps or clusters and skewness.

**What features are apparent in box plots but not in violin plots?**


Box plots rimarily show the basic statistical summary, wth items like mean and median.
...
There is a correlations between plastic waste an mismanaged plastic waste. The more plastic waste there is,the more it seems to be mismanaged. 
...
I don't seem to see anythign except that North America has an outlier, as does Asia. North America's outlier is based in plastic waster er capita, while Asia's outlier is in mismanaged pastic waste.
...
The Plastic_waste_per_cap is slightly more  lineary associated with the coastal population, as opposed to the total population.
...
There isn't a strong linear relationship brtween coastal_pop and plastic_waste. There ar emore differences between continents than coastal population.
